  ...
  if (success) {
    return (
      <View style={[styles.flex, styles.center, { backgroundColor: C.background }]}>
        <View style={[styles.logoCircle, { backgroundColor: C.success }]}>
          <Feather name="check" size={28} color="#fff" />
        </View>
        <Text style={[styles.title, { color: C.text, fontFamily: "Inter_700Bold", marginTop: 16 }]}>
          Account Created!
        </Text>
        <Text style={[styles.subtitle, { color: C.textSecondary, fontFamily: "Inter_400Regular", marginTop: 8 }]}>
          Check your email to confirm your account
        </Text>
        <Pressable
          style={({ pressed }) => [styles.primaryBtn, { backgroundColor: C.tint, opacity: pressed ? 0.85 : 1, marginTop: 32 }]}
        ...
        <View style={styles.form}>
          <View style={styles.inputGroup}>
            ...
            <View style={[styles.inputWrapper, { backgroundColor: C.backgroundTertiary, borderColor: C.border }]}>
              <Feather name="at-sign" size={16} color={C.textTertiary} />
              <TextInput
